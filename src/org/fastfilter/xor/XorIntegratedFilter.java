 ...
 *
 */
public class XorIntegratedFilter implements Filter {
     ...
     */
    public static XorIntegratedFilter construct(Set<Long> keysIn, Set<Long> keysOut, int bitsN, int bitsF) {
        return new XorIntegratedFilter (keysIn, keysOut, bitsN, bitsF);
    }    
     ...
     * @param bitsF Number of 1-bit subfilters
     */
    XorIntegratedFilter(Set<Long> keysIn, Set<Long> keysOut, int bitsN, int bitsF) {
