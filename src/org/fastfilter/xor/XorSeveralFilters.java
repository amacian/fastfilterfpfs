 ...
 *
 */
public class XorSeveralFilters implements Filter{
     ...
     */
    public static XorSeveralFilters construct(Set<Long> keysIn, Set<Long> keysOut, int bitsN, int bitsF) {
        return new XorSeveralFilters (keysIn, keysOut, bitsN, bitsF);
    }
     ...
     * @param bitsF Number of 1-bit additional filters (1 for TF)
     */	
	XorSeveralFilters (Set<Long> keysIn, Set<Long> keysOut, int bitsN, int bitsF){
