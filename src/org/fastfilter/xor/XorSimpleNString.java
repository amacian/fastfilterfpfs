 ...
 *
 */
public class XorSimpleNString implements StringFilter {
     ...
     */
    public static XorSimpleNString construct(Set<String> keys, int bitsPerFingerprint) {
        return new XorSimpleNString (keys, bitsPerFingerprint);
    }
     ...
     * @return a new Filter with the selected parameters
     */
    public static XorSimpleNString construct(Set<String> keys, int bitsPerFingerprint, int tSize) {
        return new XorSimpleNString (keys, bitsPerFingerprint, tSize);
    }
     ...
     * @return a new Filter with the selected parameters
     */
    XorSimpleNString(Set<String> keys, int bitsPerFingerprint) {
     ...
     * @return a new Filter with the selected parameters
     */
    XorSimpleNString(Set<String> keys, int bitsPerFingerprint, int tsize) {
    ...
    boolean map(Set<String> keys, HashFunction hf, long[] stack) {
